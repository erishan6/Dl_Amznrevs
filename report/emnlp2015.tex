...
in~\cite{PB:2010}, but write as in~\cite{Ganin:2016} when more than two
authors are involved. Collapse multiple citations as
in~\cite{Gusfield:97,PB:2010}. Also refrain from using full citations
...
{\em Computing Reviews\/}~\cite{Chen:2016}.
